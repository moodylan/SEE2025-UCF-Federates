...
public class LunarAssistantFederate extends SEEAbstractFederate implements Observer {

	private LunarAssistant lunarAssistant = null;
	private String local_settings_designator = null;

	public LunarAssistantFederate(SEEAbstractFederateAmbassador seefedamb, LunarAssistant lunarAssistant) {
		super(seefedamb);
		this.lunarAssistant  = lunarAssistant;
	}
    ...
    */
		...
		// 5. publish lunarAssistant object on RTI
		super.publishElement(lunarAssistant);
...
//		super.shudownExecution();
	...
	protected void doAction() {
		Position curr_pos = this.lunarAssistant.getPosition();
		curr_pos.setX(curr_pos.getX()+10); // update the x coordinate
		
		try {
			
			super.updateElement(this.lunarAssistant);
	...
	public void update(Observable arg0, Object arg1) {
		...
		System.out.println("The lunarAssistant has received an update");
