...
@ObjectClass(name = "PhysicalEntity.LunarAssistant")
public class LunarAssistant {
...
//	@Attribute(name = "position", coder = HLAPositonCoder.class)
	...
	public LunarAssistant() {}
	
	public LunarAssistant(String entity_name, String parent_reference_frame, String entity_type, Position position){
