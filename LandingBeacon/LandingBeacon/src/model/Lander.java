...
public class Lander {
	...
	// this is the position that DON is listening to.
	// DON will listen all the physical 
	// if you want to move something, just go to the state of it, where it start velocity
	// then justchange the position
	// if you move somt from 0 to 10, dont worry, DON does the movement for you
	// just change teh position overtime
	// find SpaceTimeCoordinateStateCoder and locate state and change position values
